...
- 考生与同校同学竞争，非全市竞争（校内竞争模式）
- **仅限户籍生参与**：必须同时满足 ①广州市户籍（或政策性照顾资格）②应届毕业生 ③同一初中就读满三年；普通非户籍生（随迁子女）不能参加名额分配
- 设有最低录取控制线（= 该校近三年统招首批次户籍生录取最低分的平均值下降40分，且不得低于当年普高最低控制线）
- 不享受加分或优先录取待遇（只看裸分）
- 设3个志愿，采用梯度控制线上志愿优先投档方式
- 参考科目要求：示范性高中须达到C级及以上，非示范性须达到D级及以上
